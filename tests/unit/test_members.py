...
from family.constants import Gender
...
#        self.assertRaises(ValueError, Member, 2, "SomeOtherPerson", "Queer")
    ...
    @patch('family.member.Member.get_paternal_grandmother', side_effect=[
        None,
        create_fake_member(),
    ...
    @patch('family.member.Member.get_maternal_grandmother', side_effect=[
        None,
        create_fake_member(),
    ...
    @patch('family.member.Member.get_siblings', return_value=[
        create_fake_member(
    ...
    @patch('family.member.Member.get_spouse_siblings', return_value=[
        create_fake_member(name="A", gender=Gender.male),
        create_fake_member(name="B", gender=Gender.female)
    ])
    @patch('family.member.Member.get_sibling_spouses', return_value=[
    ...
    @patch('family.member.Member.get_siblings')
    @patch('family.member.Member.get_daughter')
    @patch('family.member.Member.get_son')
    @patch('family.member.Member.get_sister_in_law')
    @patch('family.member.Member.get_brother_in_law')
    @patch('family.member.Member.get_maternal_uncle')
    @patch('family.member.Member.get_maternal_aunt')
    @patch('family.member.Member.get_paternal_uncle')
    @patch('family.member.Member.get_paternal_aunt')
